...
const ExclusivitySection = () => {
  ...
  return (
    <section id="exclusive" className="relative z-10 mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
      <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          >
            Strict Limit · No Exceptions
          </motion.div>
          <h2 className="text-3xl font-bold tracking-tight text-ink sm:text-4xl lg:text-4xl leading-[1.2] mb-6">
            Only <span className="text-green italic">20 companies</span> will share this stage.
          </h2>
          <div className="space-y-6 text-sm font-medium leading-relaxed text-ink-soft sm:text-lg">
            <p>
          ...
          <div className="mt-10">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 rounded-xl bg-green px-8 py-4 text-lg font-bold text-paper transition-all hover:bg-green-deep hover:shadow-xl hover:-translate-y-0.5"
            >
              Claim a Slot
        ...
        >
          ...
          <div className="relative z-10">
            <div className="mb-8 flex items-center justify-between border-b border-paper/10 pb-6">
              <div>
                <div className="text-[10px] font-black uppercase tracking-widest text-paper/40">Sponsor Slots · Live</div>
                <div className="mt-1 text-2xl font-bold text-paper">14 of 20 open</div>
              </div>
              <div className="rounded-full bg-green/20 px-4 py-1 text-xs font-bold text-green-bright animate-pulse">
                Live Status
              </div>
            </div>
            ...
            <div className="mt-8 flex items-center gap-6 text-[10px] font-bold uppercase tracking-widest text-paper/40">
