    ...
    <main className="relative min-h-screen overflow-hidden bg-bg">
      ...
      <nav className="nav-glass fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 lg:px-12 bg-bg/80 backdrop-blur-xl border-b border-line">
        ...
        <div className="flex items-center gap-4">
          <a href="#contact" className="hidden sm:inline-flex rounded-full bg-ink px-5 py-2.5 text-[10px] font-black uppercase tracking-widest text-bg transition-all hover:bg-green hover:-translate-y-0.5 shadow-lg shadow-ink/10">
            Reserve a Slot
          </a>
